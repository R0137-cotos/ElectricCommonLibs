...
@Data
public class ElectricContractExtDto {
	...
	private ElectricPlan co2EmissionFactor;
	 ...
	 */
	@NotNull
	@ApiModelProperty(value = "契約容量(従量電灯)", required = true, position = 30, allowableValues = "range[0,255]")
	 ...
	 */
	@NotNull
	@ApiModelProperty(value = "契約電流", required = true, position = 31, allowableValues = "range[0,255]")
	 ...
	 */
	@NotNull
	@ApiModelProperty(value = "契約電力(動力)", required = true, position = 32, allowableValues = "range[0,255]")
	 ...
	 */
	@NotNull
	@ApiModelProperty(value = "負荷率", required = true, position = 33, allowableValues = "range[0,255]")
