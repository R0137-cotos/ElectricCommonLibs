...
public class ElectricExpertEstimationExtDto {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "所属課所コード", required = false, position = 2, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "修正時振替先コード", required = false, position = 3, allowableValues = "range[0,255]")
