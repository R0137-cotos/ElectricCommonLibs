...
public class ElectricDealerContract extends EntityBase {
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "販売店企業名", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,1000]")
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "事業所電話番号", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "住所", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,4000]")
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "メールアドレス1", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "メールアドレス3", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,255]")
