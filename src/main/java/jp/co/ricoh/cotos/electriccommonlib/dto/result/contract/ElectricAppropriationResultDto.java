...
public class ElectricAppropriationResultDto {
	 ...
	 * 登録日時
	 */
	@ApiModelProperty(value = "登録日時", required = false, position = 101)
	private Date createdAt;

	/**
	 * 登録者
	 */
	@ApiModelProperty(value = "登録者", required = false, position = 102, allowableValues = "range[0,255]")
	private String createdUserId;

	/**
	 * 更新日時
	 */
	@ApiModelProperty(value = "更新日時", required = false, position = 103)
	private Date updatedAt;

	/**
	 * 更新者
	 */
	@ApiModelProperty(value = "更新者", required = false, position = 104, allowableValues = "range[0,255]")
	private String updatedUserId;

	/**
	 * version
	 */
	@ApiModelProperty(value = "version", required = false, position = 105, allowableValues = "range[0,9223372036854775807]")
	private long version;

	/**
	 * 契約（電力）ID
	 */
	@ApiModelProperty(value = "ID", required = false, position = 1, allowableValues = "range[0,9223372036854775807]")
	private long contractElectricId;

	/**
	 * 請求基本情報ID
	 */
	@ApiModelProperty(value = "請求基本情報ID", required = false, position = 3)
	private long billingBasicInformationId;

	/**
	 * 請求実績ID
	 */
	@ApiModelProperty(value = "請求実績ID", required = false, position = 4)
	private long billingHistoryId;

	/**
	 * 請求年月
	 */
	@ApiModelProperty(value = "請求年月", required = false, position = 5, allowableValues = "range[0,255]")
	 ...
	 * 料金計算実行番号
	 */
	@ApiModelProperty(value = "料金計算実行番号", required = false, position = 7, allowableValues = "range[0,255]")
	private String calcExecNumber;

	/**
	 * NISHIKI契約番号
	 */
	@ApiModelProperty(value = "NISHIKI契約番号", required = false, position = 8, allowableValues = "range[0,255]")
	private String nishikiContractNumber;

	/**
	 * 販社コード
	 */
	@ApiModelProperty(value = "販社コード", required = false, position = 9, allowableValues = "range[0,255]")
	private String tradingCompanyCode;

	/**
	 * 所轄課所コード
	 */
	@ApiModelProperty(value = "所轄課所コード", required = false, position = 10, allowableValues = "range[0,255]")
	private String affiliationCode;

	/**
	 * 仕入取引先コード
	 */
	@ApiModelProperty(value = "仕入取引先コード", required = false, position = 11, allowableValues = "range[0,255]")
	private String purchaserCode;

	/**
	 * リコー品種コード
	 */
	@ApiModelProperty(value = "リコー品種コード", required = false, position = 12, allowableValues = "range[0,255]")
	private String ricohItemCode;

	/**
	 * リコー電力商品名
	 */
	@ApiModelProperty(value = "リコー電力商品名", required = false, position = 13, allowableValues = "range[0,255]")
