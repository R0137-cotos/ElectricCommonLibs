 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "従量料金_夏季_売価", required = false, position = 14)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "従量料金_夏季_仕切価格（営業）", required = false, position = 15)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "従量料金_その他季_売価", required = false, position = 16)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "従量料金_その他季_仕切価格（営業）", required = false, position = 17)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_予備線_売価", required = false, position = 18)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_予備線_仕切価格（営業）", required = false, position = 19)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_予備電源_売価", required = false, position = 20)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_予備電源_仕切価格（営業）", required = false, position = 21)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_アンシラリー_売価", required = false, position = 22)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "オプション_アンシラリー_仕切価格（営業）", required = false, position = 23)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "媒介手数料　定額（円：税込）", required = false, position = 24)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "媒介手数料　定率（％）", required = false, position = 25)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "電力料金（営業）", required = false, position = 26)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "粗利額（営業）", required = false, position = 27)
 ...
 */
@Column(nullable = true)
@ApiModelProperty(value = "粗利率（％）（営業）", required = false, position = 28)
