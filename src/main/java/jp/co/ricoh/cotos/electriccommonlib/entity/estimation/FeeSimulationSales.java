...
public class FeeSimulationSales extends EntityBase {
	 ...
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fee_simulation_sales_seq")
	@SequenceGenerator(name = "fee_simulation_sales_seq", sequenceName = "fee_simulation_sales_seq", allocationSize = 1)
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "従量料金_夏季_売価", required = false, position = 14, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "従量料金_夏季_仕切価格（営業）", required = false, position = 15, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "従量料金_その他季_売価", required = false, position = 16, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "従量料金_その他季_仕切価格（営業）", required = false, position = 17, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "オプション_予備線_売価", required = false, position = 18, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "オプション_予備線_仕切価格（営業）", required = false, position = 19, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "オプション_予備電源_仕切価格（営業）", required = false, position = 21, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "オプション_アンシラリー_売価", required = false, position = 22, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "オプション_アンシラリー_仕切価格（営業）", required = false, position = 23, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "媒介手数料　定額（円：税込）", required = false, position = 24, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "媒介手数料　定率（％）", required = false, position = 25, allowableValues = "range[0.00,99999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "電力料金（営業）", required = false, position = 26, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Column(nullable = true)
	@ApiModelProperty(value = "粗利額（営業）", required = false, position = 27, allowableValues = "range[0.00,9999999999999999999.99]")
