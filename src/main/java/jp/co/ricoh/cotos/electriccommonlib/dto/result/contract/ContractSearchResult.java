...
public class ContractSearchResult {
	 ...
	 * 案件番号
	 */
	@ApiModelProperty(value = "案件番号", required = false, position = 18, allowableValues = "range[0,255]")
	private String caseNumber;

	/**
	 * 案件名
	 */
	@ApiModelProperty(value = "案件名", required = false, position = 19, allowableValues = "range[0,255]")
	private String caseTitle;

	/**
	 * SIM番号
	 */
	@ApiModelProperty(value = "SIM番号", required = false, position = 20, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "契約書初回作成日", required = false, position = 21)
	private Date contractFirstCreationDate;

	/**
	 * 請求開始月
	 */
	@ApiModelProperty(value = "請求開始月", required = false, position = 22)
	 ...
	 */
	@Temporal(TemporalType.TIMESTAMP)
	@ApiModelProperty(value = "サービス開始", required = false, position = 23)
	 ...
	 */
	@Temporal(TemporalType.TIMESTAMP)
	@ApiModelProperty(value = "サービス終了", required = false, position = 24)
	private Date contractYmdEnd;

	/**
	 * 電力区分
	 */
	@ApiModelProperty(value = "電力区分", required = false, position = 25, allowableValues = "range[0,255]")
	private VoltageCategory voltageCategory;

	/**
	 * お客様識別番号
	 */
	@ApiModelProperty(value = "お客様識別番号", required = false, position = 26, allowableValues = "range[0,255]")
	private String customerNumber;

	/**
	 * 供給地点特定番号
	 */
	@ApiModelProperty(value = "供給地点特定番号", required = false, position = 27, allowableValues = "range[0,255]")
