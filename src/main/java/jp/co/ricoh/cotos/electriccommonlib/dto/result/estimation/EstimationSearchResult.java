...
public class EstimationSearchResult {
	 ...
	 * 見積ステータス
	 */
	@ApiModelProperty(value = "見積ステータス", required = false, position = 9, allowableValues = "作成中(\"1\"), 業務依頼中(\"2\"), 業務処理完了(\"3\"), 承認依頼中(\"4\"), 承認済(\"5\"), 顧客提示済(\"6\")")
	private WorkflowStatus status;

	/**
	 * 見積状態
	 */
	@ApiModelProperty(value = "見積状態", required = false, position = 10, allowableValues = "作成中(\"1\"), 作成完了(\"2\"), 受注(\"3\"), 失注(\"4\"), 破棄(\"5\")")
	 ...
	 * SIM番号
	 */
	@ApiModelProperty(value = "SIM番号", required = false, position = 13, allowableValues = "range[0,255]")
	private String simNumber;

	/**
	 * 基本料金_売価
	 */
	@ApiModelProperty(value = "基本料金_売価", required = false, position = 14, allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 * オプション_予備線_売価
	 */
	@ApiModelProperty(value = "オプション_予備線_売価", required = false, position = 17, allowableValues = "range[0.00,9999999999999999999.99]")
	private BigDecimal spareLineSellingPrice;

	/**
	 * オプション_予備電源_売価
	 */
	@ApiModelProperty(value = "オプション_予備電源_売価", required = false, position = 18, allowableValues = "range[0.00,9999999999999999999.99]")
	private BigDecimal sparePowerSellingPrice;

	/**
	 * オプション_アンシラリー_売価
	 */
	@ApiModelProperty(value = "オプション_アンシラリー_売価", required = false, position = 19, allowableValues = "range[0.00,9999999999999999999.99]")
