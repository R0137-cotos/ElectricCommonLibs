...
public class ContractElectricChangePlanExtDto {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "現在の電力会社", required = false, position = 15, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "現在の契約番号", required = false, position = 43, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電力エリア", required = false, position = 19, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電源サイクル", required = false, position = 26, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "契約数量", required = false, position = 27, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "契約容量(従量電灯)", required = false, position = 28, allowableValues = "range[0.00,99999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "契約電流", required = false, position = 29, allowableValues = "range[0.00,99999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "契約電力(動力)", required = false, position = 30, allowableValues = "range[0.00,99999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "負荷率", required = false, position = 32, allowableValues = "range[0.00,99999999.99]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "修正時振替先コード", required = false, position = 34, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "ご契約者情報　供給地点特定番号", required = false, position = 35, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "ご契約者情報　簡略名称", required = false, position = 36, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 氏名", required = false, position = 37, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 電話番号", required = false, position = 38, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 所属名", required = false, position = 39, allowableValues = "range[0,255]")
