...
public class ContractElectricChangePlanExtDto {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "現在の契約番号", required = true, position = 43, allowableValues = "range[0,255]")
	...
	@NotNull
	@Size(max = 255)
	@ApiModelProperty(value = "品種コード", required = true, position = 25, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電源サイクル", required = true, position = 26, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "契約数量", required = true, position = 27, allowableValues = "range[0,255]")
	...
	@NotNull
	@Size(max = 255)
	@ApiModelProperty(value = "供給開始予定日", required = true, position = 27, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "契約容量(従量電灯)", required = true, position = 28, allowableValues = "range[0.00,99999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "契約電流", required = true, position = 29, allowableValues = "range[0.00,99999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "契約電力(動力)", required = true, position = 30, allowableValues = "range[0.00,99999999.99]")
	...
	@NotNull
	@Size(max = 255)
	@ApiModelProperty(value = "契約単位", required = true, position = 31, allowableValues = "range[0,255]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 8, fraction = 2)
	@ApiModelProperty(value = "負荷率", required = true, position = 32, allowableValues = "range[0.00,99999999.99]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "基本検針日(低圧)", required = true, position = 33, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "修正時振替先コード", required = true, position = 34, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "ご契約者情報　供給地点特定番号", required = true, position = 35, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "ご契約者情報　簡略名称", required = true, position = 36, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 氏名", required = true, position = 37, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 電話番号", required = true, position = 38, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "電気主任技術者 - 所属名", required = true, position = 39, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "供給開始月", required = true, position = 41, allowableValues = "range[0,255]")
	...
	@Max(9)
	@Min(0)
	@ApiModelProperty(value = "振込フラグチェック(業務区)", required = true, position = 42, allowableValues = "range[0,9]")
