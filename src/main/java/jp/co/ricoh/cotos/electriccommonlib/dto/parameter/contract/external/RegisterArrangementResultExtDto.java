...
public class RegisterArrangementResultExtDto {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "変更希望日", required = false, position = 3, allowableValues = "range[0,255]")
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "契約(電力)", required = true, position = 4)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "顧客", required = true, position = 5)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "契約担当者メールアドレス", required = true, position = 6)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "請求先メールアドレスリスト", required = true, position = 7)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "契約担当SA社員", required = true, position = 8)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "追加編集者", required = true, position = 10)
