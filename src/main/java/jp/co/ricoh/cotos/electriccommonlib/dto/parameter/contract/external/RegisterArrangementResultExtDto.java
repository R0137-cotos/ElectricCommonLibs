...
public class RegisterArrangementResultExtDto {
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "契約(電力)", required = true, position = 7)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "顧客", required = true, position = 8)
	 ...
	 */
	@Valid
	@ApiModelProperty(value = "契約担当者メールアドレス", required = false, position = 9)
	 ...
	 */
	@Valid
	@ApiModelProperty(value = "請求先メールアドレスリスト", required = false, position = 10)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "契約担当SA社員", required = true, position = 11)
	...
	@Valid
	@NotNull
	@ApiModelProperty(value = "電力専任情報", required = true, position = 12)
	 ...
	 */
	@Valid
	@ApiModelProperty(value = "追加編集者", required = false, position = 13)
