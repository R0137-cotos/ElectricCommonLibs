...
public class RepositoryTestBase {
	...
	@Transactional
	public <T extends EntityBaseMaster, ID extends Serializable> void 全てのカラムがNullではないことを確認_マスタ(CrudRepository<T, ID> repository, @SuppressWarnings("unchecked") ID... ids) {
