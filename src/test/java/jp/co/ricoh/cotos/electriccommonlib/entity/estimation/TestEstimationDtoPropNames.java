...
public class TestEstimationDtoPropNames {

	private static final String ESTIMATION_DTO_PARAM_PACKAGE = "jp.co.ricoh.cotos.electriccommonlib.dto.parameter.estimation";

	@Test
	public void Dtoの全項目が対となるEntityに存在することを確認() {

		Reflections reflections = new Reflections(ESTIMATION_DTO_PARAM_PACKAGE);
