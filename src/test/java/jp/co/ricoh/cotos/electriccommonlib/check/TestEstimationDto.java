...
public class TestEstimationDto {
	...
	public void EstimationUpdateParameterのテスト() throws Exception {
		...
		estimationElectricDto.setElectricExpertEstimationDto(electricExpertEstimationDto);
		estimationElectricDto.setFeeSimulationHeadDto(feeSimulationHeadDto);
		estimationElectricDto.setElectricDealerEstimationDto(electricDealerEstimationDto);
